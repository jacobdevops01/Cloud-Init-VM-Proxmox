📘 Документация: Cloud-Init в Proxmox (пошагово)
🧠 Что будет в итоге
...
Настраиваешь шаблон один раз

Потом клонируешь сотни ВМ быстро

Каждая ВМ получает уникальные параметры

Подходит для DevOps/облаков
